        ...
        if ($user) {
            ...
            if ($db->runQuery($update_sql, [':id' => $id_user])) {
                ...
                echo "<script>
                        ...
                        window.location.href='/lab11_php_oop/index.php/user/index';
                      </script>";
                exit;
            }
        } else {
...
<body>
    <div class="card-otp">
        ...
        <div class="mt-4">
            ...
            <a href="/lab11_php_oop/index.php/user/daftar" class="text-decoration-none fw-bold text-success ms-1">Daftar Ulang</a>
        </div>
    </div>
</body>
</html>