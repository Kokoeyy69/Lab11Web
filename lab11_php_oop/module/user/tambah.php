...
if (!isset($_SESSION['is_login']) || $_SESSION['role'] !== 'admin') {
    echo "<script>alert('Akses Ditolak: Anda tidak memiliki izin untuk menambah pengguna!'); window.location.href='/lab11_php_oop/index.php/home/index';</script>";
    exit;
}
        ...
        // B. Cek duplikasi username menggunakan PDO
            ...
            if ($check->rowCount() > 0) {
                ...
                if ($db->runQuery($sql, $params)) {
                    echo "<script>alert('User berhasil ditambahkan!'); window.location='/lab11_php_oop/index.php/user/index';</script>";
                    exit;
                }
            }
        }
...
<div class="row justify-content-center px-3 mt-4 fade-in mb-5">
    <div class="col-xl-8 col-lg-10">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/lab11_php_oop/index.php/user/index" class="btn btn-light border rounded-pill shadow-sm px-4 fw-bold">
