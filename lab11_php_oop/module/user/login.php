    ...
    try {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if (isset($user['is_active']) && $user['is_active'] == 0) {
                $message = "Akun belum aktif! <br> <a href='/lab11_php_oop/index.php/user/verifikasi' class='fw-bold text-white text-decoration-underline'>Klik disini untuk verifikasi OTP</a>";
            } else {
