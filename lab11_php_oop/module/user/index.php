                            ...
                            <tr class="transition">
                                ...
                                <td class="text-end pe-4">
                                    <?php if($row['username'] != $_SESSION['username']): ?>
                                        <a href="/lab11_php_oop/index.php/user/edit?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary border-0"><i class="fas fa-edit"></i></a>
                                        <a href="/lab11_php_oop/index.php/user/hapus?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger border-0" onclick="return confirm('Hapus user?')"><i class="fas fa-trash"></i></a>
                                    <?php else: ?>
                                        <a href="/lab11_php_oop/index.php/user/profile" class="badge bg-light text-primary border px-3 py-2 rounded-pill text-decoration-none shadow-sm">Akun Saya</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
