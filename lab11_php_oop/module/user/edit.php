...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        echo "<script>alert('Data pengguna berhasil diperbarui!'); window.location.href='/lab11_php_oop/index.php/user/index';</script>";
        exit;
    } catch (Exception $e) {
            ...
            <div class="card-body p-4 bg-white">
                ...
                <form method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-2">
                        <a href="/lab11_php_oop/index.php/user/index" class="text-muted small text-decoration-none fw-bold">
