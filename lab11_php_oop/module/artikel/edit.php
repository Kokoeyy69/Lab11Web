...
<div class="fade-in">
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="/lab11_php_oop/index.php/artikel/index" class="btn btn-light border rounded-pill shadow-sm">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <?php if($data['foto']): ?>
                                    <img src="/lab11_php_oop/assets/img/<?= $data['foto'] ?>" class="rounded shadow-sm" width="60" height="60">
                                <?php endif; ?>
