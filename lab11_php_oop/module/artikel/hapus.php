    ...
    try {
        ...
        if ($data) {
            ...
            if (!empty($data['gambar'])) {
                 ...
                 * Path DB: /lab11_php_oop/assets/img/artikel/file.jpg
                 * Path Server: C:/xampp/htdocs/lab11_php_oop/assets/img/artikel/file.jpg
                 */
                $relative_path = str_replace("/lab11_php_oop/", "", $data['gambar']);
            ...
            echo "<script>alert('Data tidak ditemukan!'); window.location='/lab11_php_oop/index.php/artikel/index';</script>";
        }
         ...
         */
        die("<script>alert('Terjadi kesalahan sistem saat menghapus data.'); window.location='/lab11_php_oop/index.php/artikel/index';</script>");
    }
} else {
