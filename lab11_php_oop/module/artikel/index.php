...
<div class="fade-in px-3 mt-4 mb-5">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2 mt-3 mt-sm-0">
            <?php if ($isAdmin): ?>
                <a href="/lab11_php_oop/index.php/artikel/cetak" target="_blank" class="btn btn-outline-secondary shadow-sm rounded-pill px-4 fw-bold">
                    <i class="fas fa-print me-2"></i>Cetak Laporan
                </a>
                <a href="/lab11_php_oop/index.php/artikel/tambah" class="btn btn-primary shadow-sm rounded-pill px-4 fw-bold">
                        ...
                        <?php if(!empty($data_artikel)): ?>
                            ...
                            <tr class="transition">
                                ...
                                <td class="pe-4 text-end">
                                    <div class="btn-group">
                                        <a href="/lab11_php_oop/index.php/artikel/ubah?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-warning rounded-circle me-2 border-0" title="Edit Artikel">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a href="/lab11_php_oop/index.php/artikel/hapus?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger rounded-circle border-0" onclick="return confirm('Apakah Anda yakin ingin menghapus artikel ini?')" title="Hapus Artikel">
