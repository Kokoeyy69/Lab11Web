...
if (!$slug) {
    header("Location: /lab11_php_oop/index.php/artikel/list");
    exit;
}
    ...
    if (!$data) {
        echo "<div class='container py-5 text-center fade-in'>
                <div class='alert alert-danger border-0 shadow-sm p-5 rounded-4'>
                    ...
                    <a href='/lab11_php_oop/index.php/artikel/list' class='btn btn-primary rounded-pill px-4 mt-3'>Kembali ke Berita</a>
                </div>
              </div>";
        exit;
    }
...
<div class="fade-in px-3 mt-4 mb-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            <a href="/lab11_php_oop/index.php/artikel/list" class="btn btn-light rounded-pill shadow-sm mb-4 border transition-scale fw-bold text-muted px-4">
