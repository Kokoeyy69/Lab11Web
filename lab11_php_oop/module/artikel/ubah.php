    ...
    try {
        ...
        if (!empty($_FILES['foto']['name'])) {
            ...
            if (in_array($ext, $allowed)) {
                ...
                if (!empty($data_lama['gambar'])) {
                    $relative_old = str_replace("/lab11_php_oop/", "", $data_lama['gambar']);
                ...
                if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_dir . $new_name)) {
                    $path_gambar = "/lab11_php_oop/assets/img/artikel/" . $new_name;
                }
            } else {
        ...
        if (empty($message)) {
            ...
            if ($db->runQuery($sql, $params)) {
                echo "<script>alert('Perubahan berhasil disimpan!'); window.location='/lab11_php_oop/index.php/artikel/index';</script>";
                exit;
            }
        }
    } catch (Exception $e) {
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-9">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="/lab11_php_oop/index.php/artikel/index" class="btn btn-light border rounded-pill shadow-sm px-4 fw-bold">
