...
--
-- Host: localhost
-- Generation Time: Dec 19, 2025 at 12:39 AM
...
INSERT INTO `user` (`id`, `username`, `password`, `foto`, `nama`, `email`, `no_hp`, `telepon`, `role`, `is_active`, `gambar`) VALUES
(1, 'admin', '$2y$10$LHg8lu529/vmLXMmrkTJDu5ylLj1ZMOxI9XKstAfMV8CAc4TTXqMi', NULL, 'Administrator', 'admin@mail.com', '', NULL, 'admin', 1, NULL),
(3, 'user', '$2y$10$o0gLYBqdpKPLp8RgZKH5ION/IPDbugedg30ZCvRtf/TFbKKelxoJq', NULL, 'user', 'user@example.com', '', NULL, 'user', 1, NULL);
