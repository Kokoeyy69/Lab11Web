...
<head>
    ...
    <style>
        ...
        /* Area Konten Utama */
        .content-wrapper {
            margin-left: var(--sidebar-width); /* Memberikan ruang agar tidak tertutup sidebar */
            flex: 1;
            padding: 2rem;
            min-height: 100vh;
            background-color: var(--bg-light);
        ...
        /* Header Konten (Opsional: Bar Navigasi Atas) */
        .topbar {
            height: 70px;
            background: #fff;
            display: flex;
        ...
        /* Style Card Modern (Konsisten dengan screenshot dashboard) */
        .card-modern {
            border: none;
            border-radius: 15px;
        ...
        @media (max-width: 991px) {
            ...
            /* Sidebar diatur via JS atau CSS di sidebar.php untuk toggle */
        }
        ...
        <div class="content-wrapper fade-in">
            <div class="topbar d-none d-md-flex justify-content-between align-items-center">
                ...
                <div class="user-info small d-flex align-items-center">
                    ...
                    <span class="badge bg-primary bg-opacity-10 text-primary px-3 rounded-pill"><?= $_SESSION['nama'] ?></span>
                </div>
            </div>